    ...
    with keys_lock:
        ...
        try:
            ...
            if not isinstance(data, dict):
                print("WARNING: keys.json غير صحيح.")
                return {}
...
def is_expired(info):
    ...
    expire = parse_datetime(info.get("expire"))
...
def telegram_post(
    ...
    if not BOT_TOKEN:
        print("ERROR: BOT_TOKEN غير موجود في Railway Variables.")
        return None
    ...
    try:
        ...
        print("TELEGRAM HTTP ERROR:", repr(e))

    except ValueError as e:
        print("TELEGRAM JSON ERROR:", repr(e))
...
def telegram_get(
    ...
    try:
        ...
        print("TELEGRAM GET ERROR:", repr(e))
...
@app.route("/check.php", methods=["GET", "POST"])
def check_key():
    ...
    try:
        ...
        with keys_lock:
            ...
            if (
                ...
                and not info.get("expired", False)
            ):
...
def run_bot():
    ...
    print("========================================")
    print("Moldes Key Bot")
    print("Telegram Polling: ON")
    print(f"Admin ID: {ADMIN_ID}")
    print("========================================")

    if not BOT_TOKEN:
        print("ERROR: BOT_TOKEN غير موجود!")
        print("أضفه في Railway Variables.")
        return
